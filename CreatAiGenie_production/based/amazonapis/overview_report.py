...
class OverviewReport(ReportBase):
    """
    Overview Report class for generating the overview report.
    ...
    def generate_report(self, start_date, end_date):
        """
        Generate the overview report from the API.
        ...
        request_params = {
            ...
            "endDate": end_date,
            "configuration": {
                "adProduct": "SPONSORED_PRODUCTS",  # Example: Customize as per the report
                "columns": ["campaignName", "impressions", "clicks", "cost", "sales"],
                "reportTypeId": "overviewReport",  # Adjust based on your specific report type
                "timeUnit": "SUMMARY",
                "format": "GZIP_JSON"
            }
        }
