...
class InventoryReport(ReportBase):
    """
    Inventory Report class for generating the Inventory report.
    ...
    def generate_report(self, start_date, end_date):
        """
        Generate the Inventory report from the API.
        ...
        # Construct API request parameters for the Inventory report
        request_params = {
            ...
            "configuration": {
                ...
                "columns": ["asin", "sku", "inventory_level", "in_stock", "out_of_stock", "backorder", "campaignId"],
                "reportTypeId": "inventoryReport",  # Adjust based on your report type
                "timeUnit": "SUMMARY",
                "format": "GZIP_JSON"
            }
        }
