...
class CampaignReport(ReportBase):
    """
    Campaign Report class for generating the campaign report.
    ...
    def generate_report(self, start_date, end_date):
        """
        Generate the campaign report from the API.
        ...
        # Construct API request parameters for the campaign report
        request_params = {
            ...
            "configuration": {
                ...
                "columns": ["campaignName", "campaignId", "impressions", "clicks", "cost", "sales"],
                "reportTypeId": "campaignReport",  # Adjust based on your report type
                "timeUnit": "SUMMARY",
                "format": "GZIP_JSON"
            }
        }
