...
class ProductReport(ReportBase):
    """
    Product Report class for generating the Product report.
    ...
    def __init__(self, api_client, email_service):
        ...
        self.report_type = "product"
        self.report_data = None
    
    def generate_report(self, start_date, end_date):
        """
        Generate the Product report from the API.
        ...
        # Construct API request parameters for the Product report
        request_params = {
            ...
            "configuration": {
                ...
                "columns": ["asin", "sku", "campaignId", "adGroupId", "impressions", "clicks", "cost", "sales", "purchases"],
                "reportTypeId": "productReport",  # Adjust based on your report type
                "timeUnit": "SUMMARY",
                "format": "GZIP_JSON"
            }
        }
